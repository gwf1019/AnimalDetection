...
As for out VGG16 model optimizing it by adding more images as well will help increase the accuracy and looking into other pretrained CNN models to use.
